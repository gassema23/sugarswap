...
export default function OnlineLobby({
        ...
        <div className="w-full mt-2">
          ...
          <div className="flex flex-col gap-1">
            ...
            {Array.from({ length: maxPlayers - players.length }).map((_, i) => (
              ...
              >
                <span style={{ display: 'inline-flex', opacity: 0.35 }}><GameIcon name="settings" size={18} /></span>
  ...
  if (status === 'ready') {
    return (
      <LobbyCard>
        <div className="flex justify-center mb-1"><GameIcon name="fruit" size={40} /></div>
  ...
  if (status === 'player_disconnected' || status === 'opponent_disconnected') {
    return (
      <LobbyCard>
        <div className="flex justify-center mb-1"><GameIcon name="close" size={40} /></div>
    ...
    <LobbyCard>
      ...
      <div className="flex gap-2 mb-4">
        {(['create', 'join'] as const).map(t => (
          ...
          >
            {t === 'create'
              ? <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}><GameIcon name="fruit" size={18} />Créer</span>
              : <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}><GameIcon name="key" size={18} />Rejoindre</span>}
          </button>
        ))}
      </div>

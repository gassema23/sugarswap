        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.72rem' }}>
              {user.totalMatches} partie{user.totalMatches !== 1 ? 's' : ''} • {user.totalPoints} pts
            </span>
          </div>
          {/* Level badge */}
          <div style={{
  ...
  return (
    ...
    >
      <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.78rem', textAlign: 'center', margin: 0 }}>
        Connecte-toi pour sauvegarder tes stats &amp; débloquer des récompenses
      </p>
      ...
      <button
        ...
        style={{
          ...
          color: '#1a1a1a', fontFamily: 'var(--font-game)',
      ...
      <button
        ...
        style={{
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
          background: '#1877F2', borderRadius: 999,
          border: 'none', cursor: 'pointer',
          padding: '7px 16px', fontSize: '0.82rem', fontWeight: 700,
          color: '#fff', fontFamily: 'var(--font-game)',
          boxShadow: '0 2px 8px rgba(0,0,0,0.3)',
        }}
      >
        {/* Facebook "f" SVG */}
      ...
      <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.7rem', textAlign: 'center', margin: 0 }}>
        Continue en tant qu'invité (stats non sauvegardées)
      </p>
    </motion.div>
  );
}
